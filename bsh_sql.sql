...
UPDATE SUBS_DELIVERY SET DELIVERY_CD='2' WHERE DELIVERY_CD='1';
INSERT INTO SUBS_PAY VALUES(3, SYSDATE, 15000, 1, 7);

UPDATE SUBS_DELIVERY SET DELIVERY_CD='1' WHERE DELIVERY_CD='3';
UPDATE SUBS_ORDER SET S_CANCEL ='N' WHERE MEMBER_NO='1';
...
-- 매주 구독하는 회원 조회
SELECT A.S_ORDER_CD, A.S_CANCEL, A.S_CYCLE, A.MEMBER_NO, A.S_CD, B.S_PRICE, C.S_PAY_NO
FROM SUBS_ORDER A
JOIN SUBS B ON (A.S_CD = B.S_CD)
JOIN SUBS_PAY C ON (A.MEMBER_NO = C.MEMBER_NO)
JOIN SUBS_DELIVERY D ON (C.S_ORDER_CD = D.S_ORDER_CD)
WHERE S_CYCLE ='1'
AND S_CANCEL = 'N';
...
SET DELIVERY_CD ='2'
WHERE EXISTS (SELECT DELIVERY_CD FROM SUBS_ORDER B WHERE B.S_CYCLE ='1' AND B.S_CYCLE = '1');


UPDATE SUBS_DELIVERY SET DELIVERY_CD = '1' WHERE DELIVERY_CD = '2';
...
SELECT MEMBER_NO, S_CYCLE, DELIVERY_CD
FROM SUBS_ORDER
...
UPDATE SUBS_ORDER SET S_CYCLE='2'
WHERE S_ORDER_CD = '7';
...
DELETE SUBS_DELIVERY WHERE DELIVERY_CD ='3';
