...
CREATE TABLE "SUBS" (
	...
	"S_ORDER_PHONE"	VARVHAR2(20)		NOT NULL,
...
COMMENT ON COLUMN "PRODUCT_REFUND"."P_REFUND_ST" IS ''Y' : 환불 완료 , 'N' : 환불 전';
...
VALUES(SEQ_OPTION_CD.NEXTVAL, 4, '1.5kg', 3000)
...
INSERT INTO PRODUCT
VALUES(SEQ_P_CD.NEXTVAL, 2, 2, '못난이참외' , 20000, DEFAULT, '못난이 참외 아주 맛나요~' , DEFAULT, SYSDATE);
