...
SELECT P_CATEGORY_NO, PRODUCT.P_CD, PRODUCT_NM, PRODUCT_PRICE, OPTION_TYPE.OPTION_CD, OPTION_NM, OPTION_PRICE, OPTION_TB.OPTION_NO
FROM PRODUCT
JOIN OPTION_TYPE ON (PRODUCT.P_CD = OPTION_TYPE.P_CD)
JOIN OPTION_TB ON (OPTION_TYPE.OPTION_CD = OPTION_TB.OPTION_CD)
JOIN CART ON (OPTION_TB.OPTION_NO = CART.OPTION_NO)
...
select TO_CHAR(PRODUCT_PRICE, 'fm999,999,999,999') 
from PRODUCT
