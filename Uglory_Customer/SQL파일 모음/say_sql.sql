...
-- 구독
SELECT MEMBER_NO, STAR_RATING, REVIEW_ENROLL_DT, REVIEW_CONTENT, S_NM FROM REVIEW
...
-- 상품
SELECT MEMBER_NO, STAR_RATING, REVIEW_ENROLL_DT, REVIEW_CONTENT, PRODUCT_NM, OPTION_NM FROM REVIEW
JOIN MEMBER ON(MEMBER.MEMBER_NO = REVIEW.MEMBER_NO)
