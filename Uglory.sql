...
ALTER TABLE ADMIN MODIFY (ADMIN_PW VARCHAR2(100));

ALTER TABLE PRODUCT_ORDER DROP COLUMN P_DL_FEE;
...
COMMENT ON COLUMN "REVIEW"."REVIEW_CD" IS '1: 구독박스, 2: 개별상품, 3: 구독 삭제, 4 : 상품 삭제';
...
CREATE TABLE "FARM" (
	...
	"FARM_ST"	CHAR(1)	DEFAULT 'Y'	NOT NULL
);
...
CREATE TABLE "REVIEW_IMG" (
	...
	"REVIEW_IMG_RENAME"	VARCHAR2(200)		NOT NULL,
...
COMMENT ON COLUMN "REVIEW_IMG"."REVIEW_IMG_RENAME" IS '이미지 수정명';
...
CREATE TABLE "MEMBER" (
	...
	"SECESSION_CD"	NUMBER		NULL,
	"SECESSION_DT"	DATE		NULL
);
...
COMMENT ON COLUMN "MEMBER"."SECESSION_CD" IS '회원탈퇴코드';

COMMENT ON COLUMN "MEMBER"."SECESSION_DT" IS '회원 탈퇴시간';
...
COMMENT ON COLUMN "PRODUCT_REFUND"."P_REFUND_DT" IS '환불 요청일';
...
COMMENT ON COLUMN "SECESSION_CNT"."SECESSION_CD" IS '회원탈퇴코드';
...
ALTER TABLE PRODUCT_DELIVERY MODIFY (DELIVERY_ST VARCHAR2(30) );

-- 배송 상태 테이블 INSERT
INSERT INTO PRODUCT_DELIVERY VALUES(
	3, '배송 완료'
);

-- 회원 탈퇴 사유 INSERT
INSERT INTO SECESSION_CNT VALUES(
	4, '비밀!!'
);
