...
-- 리뷰 상세 조회 (개별 상품)
SELECT REVIEW_ENROLL_DT, MEMBER_NAME, REVIEW_CONTENT, STAR_RATING, P_ORDER_CD
FROM REVIEW
JOIN MEMBER USING(MEMBER_NO);

SELECT REVIEW_ENROLL_DT, MEMBER_NAME, REVIEW_CONTENT, STAR_RATING, P_ORDER_CD, S_ORDER_CD
FROM REVIEW
JOIN MEMBER USING(MEMBER_NO)
WHERE P_ORDER_CD IS NOT NULL;

-- 리뷰 상세 조회 (구독)
SELECT REVIEW_ENROLL_DT, MEMBER_NAME, REVIEW_CONTENT, STAR_RATING, S_ORDER_CD
FROM REVIEW
JOIN MEMBER USING(MEMBER_NO)
WHERE S_ORDER_CD IS NOT NULL;
