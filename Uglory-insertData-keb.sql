...
SELECT P_REFUND_AMOUNT FROM PRODUCT_REFUND
...
UPDATE PRODUCT_REFUND SET P_REFUND_ST = 'Y';
UPDATE PRODUCT_REFUND SET P_REFUND_DT = TO_DATE(SYSDATE, 'YY-MM-DD');
SELECT P_REFUND_DT FROM PRODUCT_REFUND;
SELECT * FROM PRODUCT_REFUND;

-- 전체 환불 금액 조회
SELECT NVL((SELECT P_REFUND_AMOUNT FROM PRODUCT_REFUND WHERE P_REFUND_ST = 'Y'
UNION ALL
SELECT NULL FROM DUAL WHERE NOT EXISTS(SELECT P_REFUND_AMOUNT FROM PRODUCT_REFUND WHERE P_REFUND_ST = 'Y')), 0) TOTAL_REFUND_AMOUNT FROM DUAL;
