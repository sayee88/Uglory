...
-- 결제 관리 조회
SELECT S.S_ORDER_CD AS ORDER_CD, M.MEMBER_EMAIL, S.S_PAY_AMOUNT AS PAY_AMOUNT, TO_CHAR(S.S_PAY_DT, 'YYYY-MM-DD HH24:MI:SS') AS PAY_DT, '1' SORT
FROM SUBS_PAY S
JOIN MEMBER M ON S.MEMBER_NO = M.MEMBER_NO

UNION ALL

SELECT P.P_ORDER_CD AS ORDER_CD, M.MEMBER_EMAIL, P.P_PAY_AMOUNT AS PAY_AMOUNT, TO_CHAR(P.P_PAY_DT, 'YYYY-MM-DD HH24:MI:SS') AS PAY_DT, '2' SORT
FROM PRODUCT_PAY P
